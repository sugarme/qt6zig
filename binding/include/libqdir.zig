...
qtc.QDir_SetSearchPaths(prefix_str, @ptrCast(searchPaths));
    }
...
qtc.QDir_AddSearchPath(prefix_str, path_str);
    ...
    pub fn SearchPaths(prefix: []const u8) []const u8 {
        const prefix_str = qtc.libqt_string{
    .len = prefix.len,
    .data = prefix.ptr,
};
return qtc.QDir_SearchPaths(prefix_str);
    }
...
return qtc.QDir_Cd(@ptrCast(self), dirName_str);
    ...
    pub fn NameFilters(self: ?*anyopaque, ) []const u8 {
        return qtc.QDir_NameFilters(@ptrCast(self));
    }

    pub fn SetNameFilters(self: ?*anyopaque, nameFilters: []const u8) void {
        qtc.QDir_SetNameFilters(@ptrCast(self), @ptrCast(nameFilters));
    }
    ...
    pub fn OperatorSubscript(self: ?*anyopaque, param1: i64, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QDir_OperatorSubscript(@ptrCast(self), param1);
defer qtc.libqt_string_free(&_str);
...
return  _ret;
    ...
    pub fn NameFiltersFromString(nameFilter: []const u8) []const u8 {
        const nameFilter_str = qtc.libqt_string{
    .len = nameFilter.len,
    .data = nameFilter.ptr,
};
return qtc.QDir_NameFiltersFromString(nameFilter_str);
    }

    pub fn EntryList(self: ?*anyopaque, ) []const u8 {
        return qtc.QDir_EntryList(@ptrCast(self));
    }

    pub fn EntryList2(self: ?*anyopaque, nameFilters: []const u8) []const u8 {
        return qtc.QDir_EntryList2(@ptrCast(self), @ptrCast(nameFilters));
    }

    pub fn EntryInfoList(self: ?*anyopaque, ) []const u8 {
        return qtc.QDir_EntryInfoList(@ptrCast(self));
    }

    pub fn EntryInfoList2(self: ?*anyopaque, nameFilters: []const u8) []const u8 {
        return qtc.QDir_EntryInfoList2(@ptrCast(self), @ptrCast(nameFilters));
    }
...
return qtc.QDir_Mkdir(@ptrCast(self), dirName_str);
    ...
    pub fn Mkdir2(self: ?*anyopaque, dirName: []const u8, permissions: QFile::Permissions) bool {
        const dirName_str = qtc.libqt_string{
    .len = dirName.len,
    .data = dirName.ptr,
};
return qtc.QDir_Mkdir2(@ptrCast(self), dirName_str, permissions);
    }
...
return qtc.QDir_Exists2(@ptrCast(self), name_str);
    ...
    pub fn Drives() []const u8 {
        return qtc.QDir_Drives();
    }
...
return  _ret;
    ...
    pub fn Match(filters: []const u8, fileName: []const u8) bool {
        const fileName_str = qtc.libqt_string{
    .len = fileName.len,
    .data = fileName.ptr,
};
return qtc.QDir_Match(@ptrCast(filters), fileName_str);
    }
...
return  _ret;
    ...
    pub fn EntryList1(self: ?*anyopaque, filters: i32) []const u8 {
        return qtc.QDir_EntryList1(@ptrCast(self), @intCast(filters));
    }

    pub fn EntryList22(self: ?*anyopaque, filters: i32, sort: i32) []const u8 {
        return qtc.QDir_EntryList22(@ptrCast(self), @intCast(filters), @intCast(sort));
    }

    pub fn EntryList23(self: ?*anyopaque, nameFilters: []const u8, filters: i32) []const u8 {
        return qtc.QDir_EntryList23(@ptrCast(self), @ptrCast(nameFilters), @intCast(filters));
    }

    pub fn EntryList3(self: ?*anyopaque, nameFilters: []const u8, filters: i32, sort: i32) []const u8 {
        return qtc.QDir_EntryList3(@ptrCast(self), @ptrCast(nameFilters), @intCast(filters), @intCast(sort));
    }

    pub fn EntryInfoList1(self: ?*anyopaque, filters: i32) []const u8 {
        return qtc.QDir_EntryInfoList1(@ptrCast(self), @intCast(filters));
    }

    pub fn EntryInfoList22(self: ?*anyopaque, filters: i32, sort: i32) []const u8 {
        return qtc.QDir_EntryInfoList22(@ptrCast(self), @intCast(filters), @intCast(sort));
    }

    pub fn EntryInfoList23(self: ?*anyopaque, nameFilters: []const u8, filters: i32) []const u8 {
        return qtc.QDir_EntryInfoList23(@ptrCast(self), @ptrCast(nameFilters), @intCast(filters));
    }

    pub fn EntryInfoList3(self: ?*anyopaque, nameFilters: []const u8, filters: i32, sort: i32) []const u8 {
        return qtc.QDir_EntryInfoList3(@ptrCast(self), @ptrCast(nameFilters), @intCast(filters), @intCast(sort));
    }
...
/// https://doc.qt.io/qt-6/dir.html#types
