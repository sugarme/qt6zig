...
pub const qvbarmodelmapper = struct {
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QVBarModelMapper_Tr(@ptrCast(s));
...
return  _ret;
    ...
    pub fn SetFirstBarSetColumn(self: ?*anyopaque, firstBarSetColumn: i32) void {
        qtc.QVBarModelMapper_SetFirstBarSetColumn(@ptrCast(self), firstBarSetColumn);
    }
    ...
    pub fn SetLastBarSetColumn(self: ?*anyopaque, lastBarSetColumn: i32) void {
        qtc.QVBarModelMapper_SetLastBarSetColumn(@ptrCast(self), lastBarSetColumn);
    }
    ...
    pub fn SetFirstRow(self: ?*anyopaque, firstRow: i32) void {
        qtc.QVBarModelMapper_SetFirstRow(@ptrCast(self), firstRow);
    }
    ...
    pub fn SetRowCount(self: ?*anyopaque, rowCount: i32) void {
        qtc.QVBarModelMapper_SetRowCount(@ptrCast(self), rowCount);
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QVBarModelMapper_Tr2(@ptrCast(s), @ptrCast(c));
defer qtc.libqt_string_free(&_str);
...
return  _ret;
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QVBarModelMapper_Tr3(@ptrCast(s), @ptrCast(c), n);
defer qtc.libqt_string_free(&_str);
