...
pub const qevent = struct {
    ...
    pub fn OperatorAssign(self: ?*anyopaque, other: ?*anyopaque) void {
        qtc.QEvent_OperatorAssign(@ptrCast(self), @ptrCast(other));
    }

    pub fn OnOperatorAssign(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QEvent_Connect_OperatorAssign(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }

    /// Allows for overriding the related default method
    pub fn OnOperatorAssign(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QEvent_OnOperatorAssign(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }

    /// Base class method implementation
    pub fn QBaseOperatorAssign(self: ?*anyopaque, other: ?*anyopaque) void {
        qtc.QEvent_QBaseOperatorAssign(@ptrCast(self), @ptrCast(other));
    }
    ...
    pub fn RegisterEventType1(hint: i32) i32 {
        return qtc.QEvent_RegisterEventType1(hint);
    }
...
pub const qtimerevent = struct {
    ...
    pub fn New(timerId: i32) QtC.QTimerEvent {
        return qtc.QTimerEvent_new(timerId);
    }
...
/// https://doc.qt.io/qt-6/coreevent.html#types
