// Static platform plugin registration for static Qt builds
#include <QtPlugin>
#include <cstdlib>

extern "C" QObject* qt_plugin_instance();

// Embedded qwindows plugin metadata (extracted from qwindows.lib .qtmetadata section)
static const unsigned char qt6zig_qwindows_metadata_bytes[] = {
    0x51,0x54,0x4d,0x45,0x54,0x41,0x44,0x41,0x54,0x41,0x20,0x21,0x01,0x06,0x08,0x04,
    0xbf,0x02,0x78,0x3e,0x6f,0x72,0x67,0x2e,0x71,0x74,0x2d,0x70,0x72,0x6f,0x6a,0x65,
    0x63,0x74,0x2e,0x51,0x74,0x2e,0x51,0x50,0x41,0x2e,0x51,0x50,0x6c,0x61,0x74,0x66,
    0x6f,0x72,0x6d,0x49,0x6e,0x74,0x65,0x67,0x72,0x61,0x74,0x69,0x6f,0x6e,0x46,0x61,
    0x63,0x74,0x6f,0x72,0x79,0x49,0x6e,0x74,0x65,0x72,0x66,0x61,0x63,0x65,0x2e,0x35,
    0x2e,0x33,0x03,0x78,0x19,0x51,0x57,0x69,0x6e,0x64,0x6f,0x77,0x73,0x49,0x6e,0x74,
    0x65,0x67,0x72,0x61,0x74,0x69,0x6f,0x6e,0x50,0x6c,0x75,0x67,0x69,0x6e,0x04,0xa1,
    0x64,0x4b,0x65,0x79,0x73,0x81,0x67,0x77,0x69,0x6e,0x64,0x6f,0x77,0x73,0xff
};

static QPluginMetaData qt6zig_metadata_fn() {
    // Skip the "QTMETADATA !" magic string (12 bytes) to get to the Header
    return { qt6zig_qwindows_metadata_bytes + 12, sizeof(qt6zig_qwindows_metadata_bytes) - 12 };
}

static void qt6zig_ensure_plugin_registered() {
    static bool registered = false;
    if (!registered) {
        registered = true;
        QStaticPlugin sp(qt_plugin_instance, qt6zig_metadata_fn);
...
QApplication* QApplication_new(int* argc, char** argv) {
    qt6zig_ensure_plugin_registered();
