#pragma once
#ifndef QOBJECT_H_C_LIBVIRTUAL
#define QOBJECT_H_C_LIBVIRTUAL
...
protected:
	...
	mutable QObject_Event_Callback qobject_event_callback = nullptr;
	mutable QObject_EventFilter_Callback qobject_eventfilter_callback = nullptr;
	mutable QObject_TimerEvent_Callback qobject_timerevent_callback = nullptr;
	mutable QObject_ChildEvent_Callback qobject_childevent_callback = nullptr;
	mutable QObject_CustomEvent_Callback qobject_customevent_callback = nullptr;
	mutable QObject_ConnectNotify_Callback qobject_connectnotify_callback = nullptr;
	mutable QObject_DisconnectNotify_Callback qobject_disconnectnotify_callback = nullptr;
	mutable QObject_Sender_Callback qobject_sender_callback = nullptr;
	mutable QObject_SenderSignalIndex_Callback qobject_sendersignalindex_callback = nullptr;
	mutable QObject_Receivers_Callback qobject_receivers_callback = nullptr;
	mutable QObject_IsSignalConnected_Callback qobject_issignalconnected_callback = nullptr;
...
// Callback setters
	inline void setQObject_Event_Callback(QObject_Event_Callback cb) const { qobject_event_callback = cb; }
	inline void setQObject_EventFilter_Callback(QObject_EventFilter_Callback cb) const { qobject_eventfilter_callback = cb; }
	inline void setQObject_TimerEvent_Callback(QObject_TimerEvent_Callback cb) const { qobject_timerevent_callback = cb; }
	inline void setQObject_ChildEvent_Callback(QObject_ChildEvent_Callback cb) const { qobject_childevent_callback = cb; }
	inline void setQObject_CustomEvent_Callback(QObject_CustomEvent_Callback cb) const { qobject_customevent_callback = cb; }
	inline void setQObject_ConnectNotify_Callback(QObject_ConnectNotify_Callback cb) const { qobject_connectnotify_callback = cb; }
	inline void setQObject_DisconnectNotify_Callback(QObject_DisconnectNotify_Callback cb) const { qobject_disconnectnotify_callback = cb; }
	inline void setQObject_Sender_Callback(QObject_Sender_Callback cb) const { qobject_sender_callback = cb; }
	inline void setQObject_SenderSignalIndex_Callback(QObject_SenderSignalIndex_Callback cb) const { qobject_sendersignalindex_callback = cb; }
	inline void setQObject_Receivers_Callback(QObject_Receivers_Callback cb) const { qobject_receivers_callback = cb; }
	inline void setQObject_IsSignalConnected_Callback(QObject_IsSignalConnected_Callback cb) const { qobject_issignalconnected_callback = cb; }
