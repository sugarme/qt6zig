...
long long QFileDevice_ReadData(QFileDevice* self, char* data, long long maxlen) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
	return vqfiledevice->readData(data, maxlen);
	} else {
	return self->QFileDevice::readData(data, maxlen);
}
}
...
long long QFileDevice_QBaseReadData(QFileDevice* self, char* data, long long maxlen) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_ReadData_IsBase(true);
	return vqfiledevice->readData(data, maxlen);
}
}
...
void QFileDevice_OnReadData(QFileDevice* self, intptr_t slot) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_ReadData_Callback(reinterpret_cast<VirtualQFileDevice::QFileDevice_ReadData_Callback>(slot));
}
}
...
long long QFileDevice_WriteData(QFileDevice* self, const char* data, long long lenVal) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
	return vqfiledevice->writeData(data, lenVal);
	} else {
	return self->QFileDevice::writeData(data, lenVal);
}
}
...
long long QFileDevice_QBaseWriteData(QFileDevice* self, const char* data, long long lenVal) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_WriteData_IsBase(true);
	return vqfiledevice->writeData(data, lenVal);
}
}
...
void QFileDevice_OnWriteData(QFileDevice* self, intptr_t slot) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_WriteData_Callback(reinterpret_cast<VirtualQFileDevice::QFileDevice_WriteData_Callback>(slot));
}
}
...
long long QFileDevice_ReadLineData(QFileDevice* self, char* data, long long maxlen) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
	return vqfiledevice->readLineData(data, maxlen);
	} else {
	return self->QFileDevice::readLineData(data, maxlen);
}
}
...
long long QFileDevice_QBaseReadLineData(QFileDevice* self, char* data, long long maxlen) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_ReadLineData_IsBase(true);
	return vqfiledevice->readLineData(data, maxlen);
}
}
...
void QFileDevice_OnReadLineData(QFileDevice* self, intptr_t slot) {
	auto* vqfiledevice = dynamic_cast<VirtualQFileDevice*>(self);
	if (vqfiledevice && vqfiledevice->isVirtualQFileDevice) {
vqfiledevice->setQFileDevice_ReadLineData_Callback(reinterpret_cast<VirtualQFileDevice::QFileDevice_ReadLineData_Callback>(slot));
}
}
