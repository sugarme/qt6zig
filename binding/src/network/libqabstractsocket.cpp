...
long long QAbstractSocket_ReadData(QAbstractSocket* self, char* data, long long maxlen) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	return vqabstractsocket->readData(data, maxlen);
	} else {
	return self->QAbstractSocket::readData(data, maxlen);
}
}
...
long long QAbstractSocket_ReadLineData(QAbstractSocket* self, char* data, long long maxlen) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	return vqabstractsocket->readLineData(data, maxlen);
	} else {
	return self->QAbstractSocket::readLineData(data, maxlen);
}
}
...
long long QAbstractSocket_SkipData(QAbstractSocket* self, long long maxSize) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	return vqabstractsocket->skipData(maxSize);
	} else {
	return self->QAbstractSocket::skipData(maxSize);
}
}
...
long long QAbstractSocket_WriteData(QAbstractSocket* self, const char* data, long long lenVal) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	return vqabstractsocket->writeData(data, lenVal);
	} else {
	return self->QAbstractSocket::writeData(data, lenVal);
}
}
...
void QAbstractSocket_SetSocketState(QAbstractSocket* self, int state) {
	...
	self->QAbstractSocket::setSocketState(static_cast<QAbstractSocket::SocketState>(state));
}
}
...
void QAbstractSocket_SetSocketError(QAbstractSocket* self, int socketError) {
	...
	self->QAbstractSocket::setSocketError(static_cast<QAbstractSocket::SocketError>(socketError));
}
}
...
void QAbstractSocket_SetLocalPort(QAbstractSocket* self, uint16_t port) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	vqabstractsocket->setLocalPort(port);
	} else {
	self->QAbstractSocket::setLocalPort(port);
}
}
...
void QAbstractSocket_SetPeerPort(QAbstractSocket* self, uint16_t port) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	vqabstractsocket->setPeerPort(port);
	} else {
	self->QAbstractSocket::setPeerPort(port);
}
}
...
void QAbstractSocket_SetPeerName(QAbstractSocket* self, const libqt_string name) {
	auto* vqabstractsocket = dynamic_cast<VirtualQAbstractSocket*>(self);
	if (vqabstractsocket && vqabstractsocket->isVirtualQAbstractSocket) {
	vqabstractsocket->setPeerName(QString::fromUtf8(name.data, name.len));
	} else {
	self->QAbstractSocket::setPeerName(QString::fromUtf8(name.data, name.len));
}
}
