...
pub const qaudiosink = struct {
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QAudioSink_Tr(@ptrCast(s));
...
return  _ret;
    ...
    pub fn SetBufferSize(self: ?*anyopaque, bytes: i64) void {
        qtc.QAudioSink_SetBufferSize(@ptrCast(self), bytes);
    }
    ...
    pub fn SetVolume(self: ?*anyopaque, volume: f64) void {
        qtc.QAudioSink_SetVolume(@ptrCast(self), volume);
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QAudioSink_Tr2(@ptrCast(s), @ptrCast(c));
defer qtc.libqt_string_free(&_str);
...
return  _ret;
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QAudioSink_Tr3(@ptrCast(s), @ptrCast(c), n);
defer qtc.libqt_string_free(&_str);
