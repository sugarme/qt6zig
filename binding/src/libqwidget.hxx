#pragma once
#ifndef QWIDGET_H_C_LIBVIRTUAL
#define QWIDGET_H_C_LIBVIRTUAL
...
protected:
	...
	mutable QWidget_DevType_Callback qwidget_devtype_callback = nullptr;
	mutable QWidget_SetVisible_Callback qwidget_setvisible_callback = nullptr;
	mutable QWidget_SizeHint_Callback qwidget_sizehint_callback = nullptr;
	mutable QWidget_MinimumSizeHint_Callback qwidget_minimumsizehint_callback = nullptr;
	mutable QWidget_HeightForWidth_Callback qwidget_heightforwidth_callback = nullptr;
	mutable QWidget_HasHeightForWidth_Callback qwidget_hasheightforwidth_callback = nullptr;
	mutable QWidget_PaintEngine_Callback qwidget_paintengine_callback = nullptr;
	mutable QWidget_Event_Callback qwidget_event_callback = nullptr;
	mutable QWidget_MousePressEvent_Callback qwidget_mousepressevent_callback = nullptr;
	mutable QWidget_MouseReleaseEvent_Callback qwidget_mousereleaseevent_callback = nullptr;
	mutable QWidget_MouseDoubleClickEvent_Callback qwidget_mousedoubleclickevent_callback = nullptr;
	mutable QWidget_MouseMoveEvent_Callback qwidget_mousemoveevent_callback = nullptr;
	mutable QWidget_WheelEvent_Callback qwidget_wheelevent_callback = nullptr;
	mutable QWidget_KeyPressEvent_Callback qwidget_keypressevent_callback = nullptr;
	mutable QWidget_KeyReleaseEvent_Callback qwidget_keyreleaseevent_callback = nullptr;
	mutable QWidget_FocusInEvent_Callback qwidget_focusinevent_callback = nullptr;
	mutable QWidget_FocusOutEvent_Callback qwidget_focusoutevent_callback = nullptr;
	mutable QWidget_EnterEvent_Callback qwidget_enterevent_callback = nullptr;
	mutable QWidget_LeaveEvent_Callback qwidget_leaveevent_callback = nullptr;
	mutable QWidget_PaintEvent_Callback qwidget_paintevent_callback = nullptr;
	mutable QWidget_MoveEvent_Callback qwidget_moveevent_callback = nullptr;
	mutable QWidget_ResizeEvent_Callback qwidget_resizeevent_callback = nullptr;
	mutable QWidget_CloseEvent_Callback qwidget_closeevent_callback = nullptr;
	mutable QWidget_ContextMenuEvent_Callback qwidget_contextmenuevent_callback = nullptr;
	mutable QWidget_TabletEvent_Callback qwidget_tabletevent_callback = nullptr;
	mutable QWidget_ActionEvent_Callback qwidget_actionevent_callback = nullptr;
	mutable QWidget_DragEnterEvent_Callback qwidget_dragenterevent_callback = nullptr;
	mutable QWidget_DragMoveEvent_Callback qwidget_dragmoveevent_callback = nullptr;
	mutable QWidget_DragLeaveEvent_Callback qwidget_dragleaveevent_callback = nullptr;
	mutable QWidget_DropEvent_Callback qwidget_dropevent_callback = nullptr;
	mutable QWidget_ShowEvent_Callback qwidget_showevent_callback = nullptr;
	mutable QWidget_HideEvent_Callback qwidget_hideevent_callback = nullptr;
	mutable QWidget_NativeEvent_Callback qwidget_nativeevent_callback = nullptr;
	mutable QWidget_ChangeEvent_Callback qwidget_changeevent_callback = nullptr;
	mutable QWidget_Metric_Callback qwidget_metric_callback = nullptr;
	mutable QWidget_InitPainter_Callback qwidget_initpainter_callback = nullptr;
	mutable QWidget_Redirected_Callback qwidget_redirected_callback = nullptr;
	mutable QWidget_SharedPainter_Callback qwidget_sharedpainter_callback = nullptr;
	mutable QWidget_InputMethodEvent_Callback qwidget_inputmethodevent_callback = nullptr;
	mutable QWidget_InputMethodQuery_Callback qwidget_inputmethodquery_callback = nullptr;
	mutable QWidget_FocusNextPrevChild_Callback qwidget_focusnextprevchild_callback = nullptr;
	mutable QWidget_UpdateMicroFocus_Callback qwidget_updatemicrofocus_callback = nullptr;
	mutable QWidget_Create_Callback qwidget_create_callback = nullptr;
	mutable QWidget_Destroy_Callback qwidget_destroy_callback = nullptr;
	mutable QWidget_FocusNextChild_Callback qwidget_focusnextchild_callback = nullptr;
	mutable QWidget_FocusPreviousChild_Callback qwidget_focuspreviouschild_callback = nullptr;
	mutable QWidget_UpdateMicroFocus1_Callback qwidget_updatemicrofocus1_callback = nullptr;
	mutable QWidget_Create1_Callback qwidget_create1_callback = nullptr;
	mutable QWidget_Create2_Callback qwidget_create2_callback = nullptr;
	mutable QWidget_Create3_Callback qwidget_create3_callback = nullptr;
	mutable QWidget_Destroy1_Callback qwidget_destroy1_callback = nullptr;
	mutable QWidget_Destroy2_Callback qwidget_destroy2_callback = nullptr;
...
// Callback setters
	inline void setQWidget_DevType_Callback(QWidget_DevType_Callback cb) const { qwidget_devtype_callback = cb; }
	inline void setQWidget_SetVisible_Callback(QWidget_SetVisible_Callback cb) const { qwidget_setvisible_callback = cb; }
	inline void setQWidget_SizeHint_Callback(QWidget_SizeHint_Callback cb) const { qwidget_sizehint_callback = cb; }
	inline void setQWidget_MinimumSizeHint_Callback(QWidget_MinimumSizeHint_Callback cb) const { qwidget_minimumsizehint_callback = cb; }
	inline void setQWidget_HeightForWidth_Callback(QWidget_HeightForWidth_Callback cb) const { qwidget_heightforwidth_callback = cb; }
	inline void setQWidget_HasHeightForWidth_Callback(QWidget_HasHeightForWidth_Callback cb) const { qwidget_hasheightforwidth_callback = cb; }
	inline void setQWidget_PaintEngine_Callback(QWidget_PaintEngine_Callback cb) const { qwidget_paintengine_callback = cb; }
	inline void setQWidget_Event_Callback(QWidget_Event_Callback cb) const { qwidget_event_callback = cb; }
	inline void setQWidget_MousePressEvent_Callback(QWidget_MousePressEvent_Callback cb) const { qwidget_mousepressevent_callback = cb; }
	inline void setQWidget_MouseReleaseEvent_Callback(QWidget_MouseReleaseEvent_Callback cb) const { qwidget_mousereleaseevent_callback = cb; }
	inline void setQWidget_MouseDoubleClickEvent_Callback(QWidget_MouseDoubleClickEvent_Callback cb) const { qwidget_mousedoubleclickevent_callback = cb; }
	inline void setQWidget_MouseMoveEvent_Callback(QWidget_MouseMoveEvent_Callback cb) const { qwidget_mousemoveevent_callback = cb; }
	inline void setQWidget_WheelEvent_Callback(QWidget_WheelEvent_Callback cb) const { qwidget_wheelevent_callback = cb; }
	inline void setQWidget_KeyPressEvent_Callback(QWidget_KeyPressEvent_Callback cb) const { qwidget_keypressevent_callback = cb; }
	inline void setQWidget_KeyReleaseEvent_Callback(QWidget_KeyReleaseEvent_Callback cb) const { qwidget_keyreleaseevent_callback = cb; }
	inline void setQWidget_FocusInEvent_Callback(QWidget_FocusInEvent_Callback cb) const { qwidget_focusinevent_callback = cb; }
	inline void setQWidget_FocusOutEvent_Callback(QWidget_FocusOutEvent_Callback cb) const { qwidget_focusoutevent_callback = cb; }
	inline void setQWidget_EnterEvent_Callback(QWidget_EnterEvent_Callback cb) const { qwidget_enterevent_callback = cb; }
	inline void setQWidget_LeaveEvent_Callback(QWidget_LeaveEvent_Callback cb) const { qwidget_leaveevent_callback = cb; }
	inline void setQWidget_PaintEvent_Callback(QWidget_PaintEvent_Callback cb) const { qwidget_paintevent_callback = cb; }
	inline void setQWidget_MoveEvent_Callback(QWidget_MoveEvent_Callback cb) const { qwidget_moveevent_callback = cb; }
	inline void setQWidget_ResizeEvent_Callback(QWidget_ResizeEvent_Callback cb) const { qwidget_resizeevent_callback = cb; }
	inline void setQWidget_CloseEvent_Callback(QWidget_CloseEvent_Callback cb) const { qwidget_closeevent_callback = cb; }
	inline void setQWidget_ContextMenuEvent_Callback(QWidget_ContextMenuEvent_Callback cb) const { qwidget_contextmenuevent_callback = cb; }
	inline void setQWidget_TabletEvent_Callback(QWidget_TabletEvent_Callback cb) const { qwidget_tabletevent_callback = cb; }
	inline void setQWidget_ActionEvent_Callback(QWidget_ActionEvent_Callback cb) const { qwidget_actionevent_callback = cb; }
	inline void setQWidget_DragEnterEvent_Callback(QWidget_DragEnterEvent_Callback cb) const { qwidget_dragenterevent_callback = cb; }
	inline void setQWidget_DragMoveEvent_Callback(QWidget_DragMoveEvent_Callback cb) const { qwidget_dragmoveevent_callback = cb; }
	inline void setQWidget_DragLeaveEvent_Callback(QWidget_DragLeaveEvent_Callback cb) const { qwidget_dragleaveevent_callback = cb; }
	inline void setQWidget_DropEvent_Callback(QWidget_DropEvent_Callback cb) const { qwidget_dropevent_callback = cb; }
	inline void setQWidget_ShowEvent_Callback(QWidget_ShowEvent_Callback cb) const { qwidget_showevent_callback = cb; }
	inline void setQWidget_HideEvent_Callback(QWidget_HideEvent_Callback cb) const { qwidget_hideevent_callback = cb; }
	inline void setQWidget_NativeEvent_Callback(QWidget_NativeEvent_Callback cb) const { qwidget_nativeevent_callback = cb; }
	inline void setQWidget_ChangeEvent_Callback(QWidget_ChangeEvent_Callback cb) const { qwidget_changeevent_callback = cb; }
	inline void setQWidget_Metric_Callback(QWidget_Metric_Callback cb) const { qwidget_metric_callback = cb; }
	inline void setQWidget_InitPainter_Callback(QWidget_InitPainter_Callback cb) const { qwidget_initpainter_callback = cb; }
	inline void setQWidget_Redirected_Callback(QWidget_Redirected_Callback cb) const { qwidget_redirected_callback = cb; }
	inline void setQWidget_SharedPainter_Callback(QWidget_SharedPainter_Callback cb) const { qwidget_sharedpainter_callback = cb; }
	inline void setQWidget_InputMethodEvent_Callback(QWidget_InputMethodEvent_Callback cb) const { qwidget_inputmethodevent_callback = cb; }
	inline void setQWidget_InputMethodQuery_Callback(QWidget_InputMethodQuery_Callback cb) const { qwidget_inputmethodquery_callback = cb; }
	inline void setQWidget_FocusNextPrevChild_Callback(QWidget_FocusNextPrevChild_Callback cb) const { qwidget_focusnextprevchild_callback = cb; }
	inline void setQWidget_UpdateMicroFocus_Callback(QWidget_UpdateMicroFocus_Callback cb) const { qwidget_updatemicrofocus_callback = cb; }
	inline void setQWidget_Create_Callback(QWidget_Create_Callback cb) const { qwidget_create_callback = cb; }
	inline void setQWidget_Destroy_Callback(QWidget_Destroy_Callback cb) const { qwidget_destroy_callback = cb; }
	inline void setQWidget_FocusNextChild_Callback(QWidget_FocusNextChild_Callback cb) const { qwidget_focusnextchild_callback = cb; }
	inline void setQWidget_FocusPreviousChild_Callback(QWidget_FocusPreviousChild_Callback cb) const { qwidget_focuspreviouschild_callback = cb; }
	inline void setQWidget_UpdateMicroFocus1_Callback(QWidget_UpdateMicroFocus1_Callback cb) const { qwidget_updatemicrofocus1_callback = cb; }
	inline void setQWidget_Create1_Callback(QWidget_Create1_Callback cb) const { qwidget_create1_callback = cb; }
	inline void setQWidget_Create2_Callback(QWidget_Create2_Callback cb) const { qwidget_create2_callback = cb; }
	inline void setQWidget_Create3_Callback(QWidget_Create3_Callback cb) const { qwidget_create3_callback = cb; }
	inline void setQWidget_Destroy1_Callback(QWidget_Destroy1_Callback cb) const { qwidget_destroy1_callback = cb; }
	inline void setQWidget_Destroy2_Callback(QWidget_Destroy2_Callback cb) const { qwidget_destroy2_callback = cb; }
