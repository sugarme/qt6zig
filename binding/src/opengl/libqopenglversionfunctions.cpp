...
bool QAbstractOpenGLFunctions_IsInitialized(const QAbstractOpenGLFunctions* self) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
	return vqabstractopenglfunctions->isInitialized();
	} else {
	return self->QAbstractOpenGLFunctions::isInitialized();
}
}
...
bool QAbstractOpenGLFunctions_QBaseIsInitialized(const QAbstractOpenGLFunctions* self) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_IsInitialized_IsBase(true);
	return vqabstractopenglfunctions->isInitialized();
}
}
...
void QAbstractOpenGLFunctions_OnIsInitialized(const QAbstractOpenGLFunctions* self, intptr_t slot) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_IsInitialized_Callback(reinterpret_cast<VirtualQAbstractOpenGLFunctions::QAbstractOpenGLFunctions_IsInitialized_Callback>(slot));
}
}
...
void QAbstractOpenGLFunctions_SetOwningContext(QAbstractOpenGLFunctions* self, const QOpenGLContext* context) {
	auto* vqabstractopenglfunctions = dynamic_cast<VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
	vqabstractopenglfunctions->setOwningContext(context);
	} else {
	self->QAbstractOpenGLFunctions::setOwningContext(context);
}
}
...
void QAbstractOpenGLFunctions_QBaseSetOwningContext(QAbstractOpenGLFunctions* self, const QOpenGLContext* context) {
	auto* vqabstractopenglfunctions = dynamic_cast<VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_SetOwningContext_IsBase(true);
	vqabstractopenglfunctions->setOwningContext(context);
}
}
...
void QAbstractOpenGLFunctions_OnSetOwningContext(QAbstractOpenGLFunctions* self, intptr_t slot) {
	auto* vqabstractopenglfunctions = dynamic_cast<VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_SetOwningContext_Callback(reinterpret_cast<VirtualQAbstractOpenGLFunctions::QAbstractOpenGLFunctions_SetOwningContext_Callback>(slot));
}
}
...
QOpenGLContext* QAbstractOpenGLFunctions_OwningContext(const QAbstractOpenGLFunctions* self) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
	return vqabstractopenglfunctions->owningContext();
	} else {
	return self->QAbstractOpenGLFunctions::owningContext();
}
}
...
QOpenGLContext* QAbstractOpenGLFunctions_QBaseOwningContext(const QAbstractOpenGLFunctions* self) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_OwningContext_IsBase(true);
	return vqabstractopenglfunctions->owningContext();
}
}
...
void QAbstractOpenGLFunctions_OnOwningContext(const QAbstractOpenGLFunctions* self, intptr_t slot) {
	auto* vqabstractopenglfunctions = dynamic_cast<const VirtualQAbstractOpenGLFunctions*>(self);
	if (vqabstractopenglfunctions && vqabstractopenglfunctions->isVirtualQAbstractOpenGLFunctions) {
vqabstractopenglfunctions->setQAbstractOpenGLFunctions_OwningContext_Callback(reinterpret_cast<VirtualQAbstractOpenGLFunctions::QAbstractOpenGLFunctions_OwningContext_Callback>(slot));
}
}
