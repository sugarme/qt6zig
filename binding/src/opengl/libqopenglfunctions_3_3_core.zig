...
pub const qopenglfunctions_3_3_core = struct {
    ...
    pub fn GlGetError(self: ?*anyopaque, ) GL {
        return qtc.QOpenGLFunctions_3_3_Core_GlGetError(@ptrCast(self));
    }
    ...
    pub fn GlGetActiveUniform(self: ?*anyopaque, program: u32, index: u32, bufSize: i32, length: *i32, size: *i32, typeVal: *GL, name: *i8) void {
        qtc.QOpenGLFunctions_3_3_Core_GlGetActiveUniform(@ptrCast(self), program, index, bufSize, @ptrCast(length), @ptrCast(size), @ptrCast(typeVal), @ptrCast(name));
    }

    pub fn GlGetActiveAttrib(self: ?*anyopaque, program: u32, index: u32, bufSize: i32, length: *i32, size: *i32, typeVal: *GL, name: *i8) void {
        qtc.QOpenGLFunctions_3_3_Core_GlGetActiveAttrib(@ptrCast(self), program, index, bufSize, @ptrCast(length), @ptrCast(size), @ptrCast(typeVal), @ptrCast(name));
    }
    ...
    pub fn GlDrawBuffers(self: ?*anyopaque, n: i32, bufs: *const GL) void {
        qtc.QOpenGLFunctions_3_3_Core_GlDrawBuffers(@ptrCast(self), n, @ptrCast(bufs));
    }
    ...
    pub fn GlCheckFramebufferStatus(self: ?*anyopaque, target: u32) GL {
        return qtc.QOpenGLFunctions_3_3_Core_GlCheckFramebufferStatus(@ptrCast(self), target);
    }
    ...
    pub fn GlGetTransformFeedbackVarying(self: ?*anyopaque, program: u32, index: u32, bufSize: i32, length: *i32, size: *i32, typeVal: *GL, name: *i8) void {
        qtc.QOpenGLFunctions_3_3_Core_GlGetTransformFeedbackVarying(@ptrCast(self), program, index, bufSize, @ptrCast(length), @ptrCast(size), @ptrCast(typeVal), @ptrCast(name));
    }
    ...
    pub fn GlGetSynciv(self: ?*anyopaque, sync: GLsync, pname: u32, bufSize: i32, length: *i32, values: *i32) void {
        qtc.QOpenGLFunctions_3_3_Core_GlGetSynciv(@ptrCast(self), sync, pname, bufSize, @ptrCast(length), @ptrCast(values));
    }
    ...
    pub fn GlWaitSync(self: ?*anyopaque, sync: GLsync, flags: u32, timeout: u64) void {
        qtc.QOpenGLFunctions_3_3_Core_GlWaitSync(@ptrCast(self), sync, flags, timeout);
    }

    pub fn GlClientWaitSync(self: ?*anyopaque, sync: GLsync, flags: u32, timeout: u64) GL {
        return qtc.QOpenGLFunctions_3_3_Core_GlClientWaitSync(@ptrCast(self), sync, flags, timeout);
    }

    pub fn GlDeleteSync(self: ?*anyopaque, sync: GLsync) void {
        qtc.QOpenGLFunctions_3_3_Core_GlDeleteSync(@ptrCast(self), sync);
    }

    pub fn GlIsSync(self: ?*anyopaque, sync: GLsync) u8 {
        return qtc.QOpenGLFunctions_3_3_Core_GlIsSync(@ptrCast(self), sync);
    }

    pub fn GlFenceSync(self: ?*anyopaque, condition: u32, flags: u32) GLsync {
        return qtc.QOpenGLFunctions_3_3_Core_GlFenceSync(@ptrCast(self), condition, flags);
    }
