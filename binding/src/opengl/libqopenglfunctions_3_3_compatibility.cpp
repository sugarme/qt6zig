...
GL QOpenGLFunctions_3_3_Compatibility_GlGetError(QOpenGLFunctions_3_3_Compatibility* self) {
...
void QOpenGLFunctions_3_3_Compatibility_GlGetActiveUniform(QOpenGLFunctions_3_3_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
	self->glGetActiveUniform(program, index, bufSize, length, size, typeVal, name);
}

void QOpenGLFunctions_3_3_Compatibility_GlGetActiveAttrib(QOpenGLFunctions_3_3_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
...
void QOpenGLFunctions_3_3_Compatibility_GlDrawBuffers(QOpenGLFunctions_3_3_Compatibility* self, int32_t n, const GL* bufs) {
...
GL QOpenGLFunctions_3_3_Compatibility_GlCheckFramebufferStatus(QOpenGLFunctions_3_3_Compatibility* self, uint32_t target) {
...
void QOpenGLFunctions_3_3_Compatibility_GlGetTransformFeedbackVarying(QOpenGLFunctions_3_3_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
...
void QOpenGLFunctions_3_3_Compatibility_GlGetSynciv(QOpenGLFunctions_3_3_Compatibility* self, GLsync sync, uint32_t pname, int32_t bufSize, int32_t* length, int32_t* values) {
...
void QOpenGLFunctions_3_3_Compatibility_GlWaitSync(QOpenGLFunctions_3_3_Compatibility* self, GLsync sync, uint32_t flags, uint64_t timeout) {
	self->glWaitSync(sync, flags, timeout);
}

GL QOpenGLFunctions_3_3_Compatibility_GlClientWaitSync(QOpenGLFunctions_3_3_Compatibility* self, GLsync sync, uint32_t flags, uint64_t timeout) {
	return self->glClientWaitSync(sync, flags, timeout);
}

void QOpenGLFunctions_3_3_Compatibility_GlDeleteSync(QOpenGLFunctions_3_3_Compatibility* self, GLsync sync) {
	self->glDeleteSync(sync);
}

unsigned char QOpenGLFunctions_3_3_Compatibility_GlIsSync(QOpenGLFunctions_3_3_Compatibility* self, GLsync sync) {
	return self->glIsSync(sync);
}

GLsync QOpenGLFunctions_3_3_Compatibility_GlFenceSync(QOpenGLFunctions_3_3_Compatibility* self, uint32_t condition, uint32_t flags) {
