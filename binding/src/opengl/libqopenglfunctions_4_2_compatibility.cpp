...
GL QOpenGLFunctions_4_2_Compatibility_GlGetError(QOpenGLFunctions_4_2_Compatibility* self) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetPointerv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t pname, void** params) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMultiDrawElements(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, const int32_t* count, uint32_t typeVal, const void** indices, int32_t drawcount) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetBufferPointerv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t pname, void** params) {
...
void QOpenGLFunctions_4_2_Compatibility_GlShaderSource(QOpenGLFunctions_4_2_Compatibility* self, uint32_t shader, int32_t count, const GLchar** stringVal, const int32_t* length) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetVertexAttribPointerv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t pname, void** pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetActiveUniform(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
	self->glGetActiveUniform(program, index, bufSize, length, size, typeVal, name);
}

void QOpenGLFunctions_4_2_Compatibility_GlGetActiveAttrib(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawBuffers(QOpenGLFunctions_4_2_Compatibility* self, int32_t n, const GL* bufs) {
...
GL QOpenGLFunctions_4_2_Compatibility_GlCheckFramebufferStatus(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetTransformFeedbackVarying(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t index, int32_t bufSize, int32_t* length, int32_t* size, GL* typeVal, GLchar* name) {
	self->glGetTransformFeedbackVarying(program, index, bufSize, length, size, typeVal, name);
}

void QOpenGLFunctions_4_2_Compatibility_GlTransformFeedbackVaryings(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t count, const GLchar** varyings, uint32_t bufferMode) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetUniformIndices(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t uniformCount, const GLchar** uniformNames, uint32_t* uniformIndices) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetSynciv(QOpenGLFunctions_4_2_Compatibility* self, GLsync sync, uint32_t pname, int32_t bufSize, int32_t* length, int32_t* values) {
...
void QOpenGLFunctions_4_2_Compatibility_GlWaitSync(QOpenGLFunctions_4_2_Compatibility* self, GLsync sync, uint32_t flags, uint64_t timeout) {
	self->glWaitSync(sync, flags, timeout);
}

GL QOpenGLFunctions_4_2_Compatibility_GlClientWaitSync(QOpenGLFunctions_4_2_Compatibility* self, GLsync sync, uint32_t flags, uint64_t timeout) {
	return self->glClientWaitSync(sync, flags, timeout);
}

void QOpenGLFunctions_4_2_Compatibility_GlDeleteSync(QOpenGLFunctions_4_2_Compatibility* self, GLsync sync) {
	self->glDeleteSync(sync);
}

unsigned char QOpenGLFunctions_4_2_Compatibility_GlIsSync(QOpenGLFunctions_4_2_Compatibility* self, GLsync sync) {
	return self->glIsSync(sync);
}

GLsync QOpenGLFunctions_4_2_Compatibility_GlFenceSync(QOpenGLFunctions_4_2_Compatibility* self, uint32_t condition, uint32_t flags) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMultiDrawElementsBaseVertex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, const int32_t* count, uint32_t typeVal, const void** indices, int32_t drawcount, const int32_t* basevertex) {
...
uint32_t QOpenGLFunctions_4_2_Compatibility_GlCreateShaderProgramv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t typeVal, int32_t count, const GLchar** strings) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetProgramBinary(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t bufSize, int32_t* length, GL* binaryFormat, void* binary) {
